// https://github.com/pavelkouril/unity-lowpoly-shader/blob/master/Assets/LowPolyShader/Shaders/LowPoly.shader

Shader "Custom/SurfaceShaderText"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag(g2f IN) : COLOR
			{
				...
				float4 colorTex = float4((IN.vertexLighting + ambientLight + diffuseReflection + specularReflection) * IN.vertexColor, 1);
