...
public class PlanetManagerEditor : Editor
{
    ...
    SerializedProperty[] t = new SerializedProperty[26];
    ...
    void Generate()
    {
        ...
        if (generate)
        {
            ...
            if (t[1].boolValue)
            {
                ...
                EditorGUI.LabelField(r, new GUIContent("Min"));
                r.x += 30;
                t[7].intValue = EditorGUI.IntField(r, t[7].intValue);
                r.x = r.x + r.width - 10;
                EditorGUI.LabelField(r, new GUIContent("Max"));
                r.x += 30;
    ...
    void Created()
    {
        ...
        if (created)
        {
            ...
            //EditorGUILayout.PropertyField(t[3]);
    ...
    private void OnEnable()
    {
        ...
        //t[3] = serializedObject.FindProperty("modifyCreated");
